...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    body{font-family:'Plus Jakarta Sans',sans-serif;background:var(--bg);color:var(--white);min-height:100vh;display:flex;overflow:hidden;}
  ...
  <div class="left-inner">
    ...
    <div class="features">
      <div class="feat">
        ...
        <div class="feat-text"><strong>AI Disease Prediction</strong><span>SVM + Decision Tree models with confidence scores</span></div>
      </div>
      <div class="feat">
        <div class="feat-icon fi-cyan">📡</div>
        <div class="feat-text"><strong>Live Doctor Alerts</strong><span>Real-time notifications via Server-Sent Events</span></div>
      </div>
      <div class="feat">
        <div class="feat-icon fi-emerald">🗺️</div>
        <div class="feat-text"><strong>Nearby Clinics & Medicines</strong><span>OpenStreetMap + OpenFDA integration</span></div>
      </div>
    </div>
  </div>
</div>
